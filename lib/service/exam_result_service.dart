...
class ExamService {
  ...
  Future<void> registerExamResult(String gestID, String examType, String value,
  ...
  Future<void> updateExamResult(String gestID, String resultExamID,
      String value, String date, BuildContext context) async {
    var day = date.substring(0, 2);
    var month = date.substring(3, 5);
    var year = date.substring(6, 10);
    DateTime da = DateTime.parse("$year-$month-$day 00:00:00.000");
    ...
    Exam exam =
        Exam(value: double.tryParse(value), dateResult: ts, registerStatus: 2);
